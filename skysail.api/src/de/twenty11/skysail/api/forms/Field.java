...
/**
 * annotate entities' fields or methods with this annotation in order to let skysail render it in its generic forms (and
 * to define other things like encryption and HtmlPolicies).
 *
 */
...
public @interface Field {
    ...
    /**
     * enrypt the field using the passphrase provided by a parameter with this name.
     */
