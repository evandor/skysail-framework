package io.skysail.product.todos;

/**
 * this is to make sure that the required modules are added to the exported jar.
 */
public class Dependencies {

    private io.skysail.domain.html.InputType inputType;
    private io.skysail.domain.Identifiable identifiable;
