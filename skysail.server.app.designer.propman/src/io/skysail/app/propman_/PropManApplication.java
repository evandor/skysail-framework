...
public class PropManApplication extends SkysailApplication implements ApplicationProvider, MenuItemProvider {
    ...
    public static final String APP_NAME = "PropMan";
    ...
    protected void attach() {
        super.attach();
        router.attach(new RouteBuilder("/Campaigns/", io.skysail.app.propman_.PostCampaignResource.class));
        router.attach(new RouteBuilder("", io.skysail.app.propman_.CampaignsResource.class));
        router.attach(new RouteBuilder("/Campaigns", io.skysail.app.propman_.CampaignsResource.class));
        router.attach(new RouteBuilder("/Campaigns/{id}", io.skysail.app.propman_.PutCampaignResource.class));
