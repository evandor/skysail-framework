...
public class OEsOEsResource extends ListServerResource<io.skysail.server.app.oEService.OE> {
    ...
    public OEsOEsResource() {
        // super(OEsio.skysail.server.app.oEService.OEResource.class);
        addToContext(ResourceContextId.LINK_TITLE, "list io.skysail.server.app.oEService.OEs for OE");
    }
