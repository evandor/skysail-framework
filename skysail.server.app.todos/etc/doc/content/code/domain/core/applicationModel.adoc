...
The Application Model describes the core domain of the skysail server. 

An application is a collection of entities, (aggregate) repositories and references between them.  
