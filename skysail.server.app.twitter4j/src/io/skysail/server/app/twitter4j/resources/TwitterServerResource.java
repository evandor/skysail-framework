...
public class TwitterServerResource extends ServerResource {
    @Get
    public Representation getMe() throws IOException, JSONException {
        ...
        ProtectedClientResource me = new ProtectedClientResource("https://api.twitter.com/1.1/statuses/home_timeline.json");
