...
//public class WikiApplicationOld extends SkysailApplication implements ApplicationProvider, MenuItemProvider {
//
...
//        router.attach(new RouteBuilder("", io.skysail.server.app.wiki.PagesResource.class));
//
//    }
//
