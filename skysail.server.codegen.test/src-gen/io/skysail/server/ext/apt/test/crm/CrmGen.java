...
public class CrmGen extends SkysailApplication implements ApplicationProvider, MenuItemProvider {

	private static final String APP_NAME = "CrmGen";
	...
	public List<MenuItem> getMenuEntries() {
		MenuItem appMenu = new MenuItem("CrmGen", "/CrmGen", this);
