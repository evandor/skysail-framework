...
public class MigrationTest {
    ...
    public void valid_path_must_have_Integer_after_V() {
        thrown.expect(IllegalArgumentException.class);
        new Migration("Vx.sql");
    }

    @Test
    public void valid_path_must_contain_underscore() {
        thrown.expect(IllegalArgumentException.class);
        new Migration("V1.sql");
    }

    @Test
    public void leading_zeros_are_ignored() {
        assertThat(new Migration("V01_xxx.sql").getVersion(), is(1));
    }

    @Test
    public void VO_is_valid() {
        new Migration("V0_xxx.sql");
    }

    @Test
    public void V3_xxx_has_version_of_3() {
        assertThat(new Migration("V3_xxx.sql").getVersion(), is(3));
    }

    @Test
    public void V3_xxx_has_title_of_xxx() {
        assertThat(new Migration("V3_xxx.sql").getTitle(), is("xxx"));
    }

    @Test
    public void V123_abc_def_has_version_of_3() {
        assertThat(new Migration("V123_abc_def.sql").getVersion(), is(123));
    }

    @Test
    public void V123_abc_def_has_title_of_abc_def() {
        assertThat(new Migration("V123_abc_def.sql").getTitle(), is("abc_def"));
    }
