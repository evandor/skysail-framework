package de.twenty11.skysail.server.ext.converter.st.renderer;
...
public class FormFieldRenderer implements AttributeRenderer {
	...
	private String pre(FormField formField, boolean hasError) {
		...
		String fieldName = formField.getFieldAnnotation().getName();
	...
	private String javascriptHtml(FormField formField, @SuppressWarnings("unused") Field field) {
		return "$(document).ready(function() { $('#s2id_" + formField.getFieldAnnotation().getName()
