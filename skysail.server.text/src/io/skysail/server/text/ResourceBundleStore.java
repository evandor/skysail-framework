...
public class ResourceBundleStore implements Store {
    ...
    public Optional<String> get(String key) {
        return Optional.of(translate(key, ResourceBundle.getBundle("translations/messages", Locale.getDefault())));
    }
    ...
    public Optional<String> get(String key, ClassLoader cl) {
        return Optional.of(translate(key, ResourceBundle.getBundle("translations/messages", Locale.getDefault(), cl)));
    }
