...
public class RequestHandler<T> {
	 ...
	 * @param cvf
	 */
	public AbstractResourceFilter<PostEntityServerResource<T>, T> createForPost(ConstraintValidatorFactory cvf) {
		return chainForEntityPost(cvf);
	}
     ...
     * @param cvf
     */
    public AbstractResourceFilter<PutEntityServerResource<T>, T> createForPut(ConstraintValidatorFactory cvf) {
        return chainForEntityPut(cvf);
    }

	// @formatter:off
	private AbstractResourceFilter<ListServerResource<T>, List<T>> chainForListPost(ConstraintValidatorFactory cvf) {
		return new ExceptionCatchingFilter<ListServerResource<T>, List<T>>()
		        ...
		        .calling(new CheckBusinessViolationsFilter<ListServerResource<T>, List<T>>(cvf))
	...
	private AbstractResourceFilter<ListServerResource<T>, List<T>> chainForListGet() {
		return new ExceptionCatchingFilter<ListServerResource<T>, List<T>>()
		        ...
		        //.calling(new AddPaginationFilter<ListServerResource<T>, List<T>>())
	...
	private AbstractResourceFilter<PostEntityServerResource<T>, T> chainForEntityPost(ConstraintValidatorFactory cvf) {
		return new ExceptionCatchingFilter<PostEntityServerResource<T>, T>()
		        ...
		        .calling(new CheckBusinessViolationsFilter<PostEntityServerResource<T>, T>(cvf))
	...
	private AbstractResourceFilter<PutEntityServerResource<T>, T> chainForEntityPut(ConstraintValidatorFactory cvf) {
        return new ExceptionCatchingFilter<PutEntityServerResource<T>, T>()
                ...
                .calling(new CheckBusinessViolationsFilter<PutEntityServerResource<T>, T>(cvf))
	...
	public AbstractResourceFilter<PostEntityServerResource<T>, T> newInstance(Method method) {
		if (method.equals(Method.GET)) {
			return new ExceptionCatchingFilter<PostEntityServerResource<T>, T>()
			        .calling(new DataExtractingFilter<PostEntityServerResource<T>, T>())
			        .calling(new AddLinkheadersFilter<PostEntityServerResource<T>, T>());
		}
