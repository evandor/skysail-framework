...
//			try {
//				validationResultJson = mapper.writeValueAsString(ValidationError.fromViolations(violations));
//				response.setEntity(validationResultJson, MediaType.APPLICATION_JSON);
//			} catch (JsonProcessingException e) {
//				response.setEntity(new StringRepresentation(e.getMessage()));
//			}
//			throw new ResourceException(Status.CLIENT_ERROR_BAD_REQUEST, "Business violations");
		}
