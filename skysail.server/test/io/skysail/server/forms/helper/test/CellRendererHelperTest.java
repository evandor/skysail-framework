...
public class CellRendererHelperTest {
    ...
    public void null_input_is_formatted_as_empty_String() {
        FormField ff = null;
        Object formatted = new CellRendererHelper(ff,null).render(null, "id", null);
    ...
    public void list_input_is_formatted_as_lists_size() {
        FormField ff = null;
        Object formatted = new CellRendererHelper(ff, null).render(Arrays.asList("1","2","3"), "id", null);
    ...
    public void set_input_is_formatted_as_sets_size() {
        ...
        FormField ff = null;
        Object formatted = new CellRendererHelper(ff, null).render(new HashSet() {{ add("1"); add("2"); }}, "id", null);
    ...
    public void huge_long_is_interpreted_as_date_and_formatted() {
        FormField ff = null;
        Object formatted = new CellRendererHelper(ff, null).render(1100000000L, "id", null);
    ...
    public void simple_listResponse_is_formatted_as_columns_value() {
        Object formatted = new CellRendererHelper(formField, listResponse).render("abc", "id", null);
    ...
    public void formField_of_type_url_is_rendered_as_link() throws Exception {new CellRendererHelperTest().getClass().getDeclaredFields();
        ...
        Object formatted = new CellRendererHelper(urlFormField, listResponse).render("abc", "id", null);
    ...
    public void formField_with_linked_listView_is_rendered_as_truncated_link() throws Exception {
        ...
        String formatted = new CellRendererHelper(linksToDefaultResourceField, listResponse).render("123456789", "id", null);
